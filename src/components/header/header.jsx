...
import { Abstract_oficial, Abstract_help_center, Solicitud, Login } from '@/utils/Enlaces'
...
export default function Header() {
    ...
    return (
        <header className="p-[15px] bg-black text-white sticky top-0 z-50 max-lg:flex max-lg:flex-col max-lg:items-center">
            <div className="w-[90%] flex justify-between items-center m-auto max-sm:flex-col max-sm:gap-3">
                <div className="flex text-[22px] items-center">
                    <div className='flex gap-2 items-center justify-center'>
                        <div className="cursor-pointer" onClick={Abstract_oficial}>
                        ...
                        <p>|</p>
                        <div className="cursor-pointer hover:underline" onClick={Abstract_help_center}>
                            <h2 className='max-sm:text-[15px] sm:test-sm'>Centro de Ayuda</h2>
                        </div>
                    </div>
                </div>
                {/*  */}
                <div className="flex gap-4 items-center max-sm:flex-col max-lg:hidden">
                    <div className="button p-2 cursor-pointer" onClick={Solicitud}>
                        <p>Enviar una Solicitud</p>
                    </div>
                    <div className="button-2 p-2 cursor-pointer" onClick={Login}>
                        <p>Iniciar sesión</p>
                    </div>
                </div>
                <div className='lg:hidden'>
                    <IoMenuSharp onClick={toggleMenu} className='w-[25px] h-auto flex self-start' />
                </div>
            </div>
            {/*  */}
            <div className=' lg:hidden'>
                <div className={`nav${isMenuActive ? '-active' : ''}`}>
                    <div className='flex flex-col gap-3'>
                        <div className="p-2 cursor-pointer" onClick={Solicitud}>
                            <p>Enviar una Solicitud</p>
                        </div>
                        <hr />
                        <div className="p-2 cursor-pointer" onClick={Login}>
                            <p>Iniciar sesión</p>
                        </div>
                    </div>
                </div>
